...
<div class="main-container">
  ...
  <div class="message-container">
    ...
    <p class="challenge-text">KEAMANAN ADALAH MITOS. KERENTANAN ADALAH LOGIKA..</p>
    <audio controls autoplay class="audio-player">
      <source src="https://k.top4top.io/m_1644rpx5n1.mp3" type="audio/mpeg">
    </audio>
    <p class="palestine-text">zenithx || BLACKHAT</p>
    <img src="x" onerror="alert('Hacked by zenithx')">
    <img src="x" onerror="alert('websitenya lemah banget')">
  </div>
</div>
</body>
</html>
